...
* Fix - Correct the quantity of tickets available in the Attendees Report admin screen because it was forcing the formatted number string (e.g. `2,000`) to an integer (displaying as `2` in this example). [ETP-149]
