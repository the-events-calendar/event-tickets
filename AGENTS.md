...
- Version placeholders in docblocks are the literal `5.29.5`: `@since 5.29.5`,
  `@deprecated 5.29.5`, `_deprecated_function( __METHOD__, '5.29.5' )`. The release
  workflow replaces them with the version being shipped. Never write a real
  version number there, and do not flag `5.29.5` as an unfinished placeholder.
