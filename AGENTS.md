...
- Version placeholders in docblocks are the literal `5.29.5.1`: `@since 5.29.5.1`,
  `@deprecated 5.29.5.1`, `_deprecated_function( __METHOD__, '5.29.5.1' )`. The release
  workflow replaces them with the version being shipped. Never write a real
  version number there, and do not flag `5.29.5.1` as an unfinished placeholder.
...
- The synced files: `.github/workflows/release-*.yml`, `lint.yml`, `phpcs.yml`,
  ...
  `.github/actionlint.yaml`, `.github/pull_request_template.md`, and this file.
  They are copies; the finding belongs in `the-events-calendar/actions`.
