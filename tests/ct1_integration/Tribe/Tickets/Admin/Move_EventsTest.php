	...
	public function get_post_choices_provider(): Generator {
		...
		yield 'recurring events' => [
			function (): array {
				...
				/*
				 * Unregister the Flexible Tickets provider: it will modify this behaviour and this test purpose is to
				 * cover the default behaviour, when Flexible Tickets is not active.
				 */
				if ( tribe()->has( Flexible_Tickets_Provider::class ) ) {
					tribe( Flexible_Tickets_Provider::class )->unregister();
				}
