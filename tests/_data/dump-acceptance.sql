...
INSERT INTO `wp_posts` VALUES (
    ...
    '',
    0,
    'http://tribe.local/?post_type=tribe_events&#038;p=1',
    0,
    'tribe_events',
    '',
    0
...
INSERT INTO `wp_posts` VALUES (
    ...
    '2018-05-08 07:57:13',
    '2018-05-08 07:57:13',
    'Welcome to <a href=\"http://tribe.local/\">Test Sites</a>. This is your first post. Edit or delete it, then start blogging!',
    'Hello world!',
    '',
    'publish',
    'open',
...
(
    3,
    1,
    '2018-05-08 07:57:13','2018-05-08 07:57:13',
    'This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href=\"http://wp.local/test1/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!',
    'Sample Page','','publish','closed','open','','sample-page','','','2018-05-08 07:57:13','2018-05-08 07:57:13','',0,'http://wp.local/test1/?page_id=2',0,'page','',0);

-- Insert RSVP for event ID 1.
INSERT INTO `wp_posts` VALUES (
    4,
	1,
    '2020-08-23 13:41:18',
    ...
    '',
    0,
    'http://tribe.local/?post_type=tribe_rsvp_tickets&#038;p=4',
    5,
    'tribe_rsvp_tickets',
    '',
    0
...
VALUES
    ...
    ( 1,	'_VenuePhone',	''),
    ( 1,	'_VenueURL',	''),
    ( 1,	'_VenueStateProvince',	''),
    ( 1,	'_VenueLat',	''),
    ( 1,	'_VenueLng',	''),
    ( 1,	'_edit_last',	'1'),
    ( 1,	'_EventDuration',	'32400'),
    ( 1,	'_EventTimezoneAbbr',	'UTC'),
    ( 1,	'_tribe_post_root',	'RSVPTEST-'),
    ( 1,	'_tribe_progressive_ticket_current_number',	'16'),
    ( 1,	'_EventRecurrence',	'a:3:{s:5:\"rules\";a:0:{}s:10:\"exclusions\";a:0:{}s:11:\"description\";N;}'),
    ( 1,	'_tribe_tickets_flush_blocks',	'1'),
    ( 1,	'_EventCost',	'0');
...
INSERT INTO `wp_postmeta`
    (`post_id`, `meta_key`, `meta_value`)
VALUES
    (4,	'_tribe_rsvp_for_event',	'1'),
    (4,	'_tribe_ticket_show_description',	'yes'),
    (4,	'_price',	'0'),
    (4,	'_manage_stock',	'yes'),
    (4,	'_stock',	'100'),
    (4,	'_tribe_ticket_capacity',	'100'),
