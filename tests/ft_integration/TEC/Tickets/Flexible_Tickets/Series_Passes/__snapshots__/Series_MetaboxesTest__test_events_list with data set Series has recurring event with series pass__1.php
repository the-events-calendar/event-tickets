<?php return '			<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
				...
				<div class="tablenav top">
					...
					<input
			type="hidden"
			id="series-occurrences-count-{{ID}}"
			data-recurring-events-count="1"
		>
...
<span class="tablenav-pages-navspan button disabled" aria-hidden="true">&raquo;</span></span></div>
	...
	<tbody id="the-list"
		 data-wp-lists=\'list:series\'		>
		<tr><td><div class="tec-events-pro-series__metabox-events-list__title-column">
	<div class="tec-events-pro-series__metabox-events-list__title-column--title">
		Recurring event 1	</div>
	<div class="tec-events-pro-series__metabox-events-list__title-column--start-date">
		February 15, 2222					<svg style="margin-left: 10px;" viewBox="0 0 12 12" width="12" height="12">
				<title>Recurring</title>
				<use xlink:href="#recurring" />
			</svg>
			</div>
</div></td><td><div class="tec-tickets__series_attached_ticket-types">
	...
	<div class="tickets__series_attached_ticket-type__title">
		Series Pass	</div>
</div></div></td><td><a href="" target="_blank" rel="noreferrer noopener">Edit</a> - <a href="http://wordpress.test/?tribe_events=recurring-event-1" target="_blank" rel="noreferrer noopener">View</a> - <a data-confirm="Are you sure you want to convert this recurring event instance into a single event? This cannot be undone." class="tec-edit-link" href="http://wordpress.test/wp-admin/post.php?post={{ID}}&amp;action=edit&amp;_tec_update_type=single&amp;nonce=###" target="_blank" rel="noreferrer noopener">Convert to Single</a></td></tr><tr><td><div class="tec-events-pro-series__metabox-events-list__title-column">
	<div class="tec-events-pro-series__metabox-events-list__title-column--title">
		Recurring event 1	</div>
	<div class="tec-events-pro-series__metabox-events-list__title-column--start-date">
		February 22, 2222					<svg style="margin-left: 10px;" viewBox="0 0 12 12" width="12" height="12">
				<title>Recurring</title>
				<use xlink:href="#recurring" />
			</svg>
			</div>
	...
	<div class="tec-events-pro-series__metabox-events-list__title-column--title">
		Recurring event 1	</div>
	<div class="tec-events-pro-series__metabox-events-list__title-column--start-date">
		March 1, 2222					<svg style="margin-left: 10px;" viewBox="0 0 12 12" width="12" height="12">
				<title>Recurring</title>
				<use xlink:href="#recurring" />
			</svg>
			</div>
	...
	<div class="tickets__series_attached_ticket-type__title">
		Series Pass	</div>
</div></div></td><td><a href="" target="_blank" rel="noreferrer noopener">Edit</a> - <a href="http://wordpress.test/?tribe_events=recurring-event-1" target="_blank" rel="noreferrer noopener">View</a> - <a data-confirm="Are you sure you want to convert this recurring event instance into a single event? This cannot be undone." class="tec-edit-link" href="http://wordpress.test/wp-admin/post.php?post={{ID}}&amp;action=edit&amp;_tec_update_type=single&amp;nonce=###" target="_blank" rel="noreferrer noopener">Convert to Single</a></td></tr>	</tbody>
