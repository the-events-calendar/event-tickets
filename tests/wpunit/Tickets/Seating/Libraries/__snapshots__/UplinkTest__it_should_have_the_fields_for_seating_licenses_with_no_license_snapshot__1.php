	...
	<div class="stellarwp-uplink__license-field">
		...
		>
			<fieldset class="stellarwp-uplink__settings-group">
				<input type=\'hidden\' name=\'option_page\' value=\'stellarwp_uplink_group_tec-seating\' /><input type="hidden" name="action" value="update" /><input type="hidden" id="_wpnonce" name="_wpnonce" value="8e72092fa4" /><input type="hidden" name="_wp_http_referer" value="" />
...
<div class="license-test-results">
	...
	<div class="key-validity"></div>
			...
			<input type="hidden" class="wp-nonce-fluent" name="stellarwp-uplink-license-key-nonce__tec-seating" value="5ef3ac9ac7" />		</div>
	</div>
',
  ),
);
