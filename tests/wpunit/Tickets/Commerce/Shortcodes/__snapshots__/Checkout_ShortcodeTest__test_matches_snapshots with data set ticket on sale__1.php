<?php return '<div class="tribe-common event-tickets">
	<section
		...
		<input type="hidden" id="tec-tc-checkout-nonce" name="tec-tc-checkout-nonce" value="46db14cf8a" /><input type="hidden" name="_wp_http_referer" value="" />		<header class="tribe-tickets__commerce-checkout-header">
