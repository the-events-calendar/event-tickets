<?php return '<div class="tribe-common event-tickets">
	<section
		...
		<input type="hidden" id="tec-tc-checkout-nonce" name="tec-tc-checkout-nonce" value="a1b2c3d4e5f6" /><input type="hidden" name="_wp_http_referer" value="" />		<header class="tribe-tickets__commerce-checkout-header">
...
<div class="tribe-tickets__commerce-checkout-cart">
	...
	<div class="tribe-tickets__commerce-checkout-cart-items">
					<article
	 class="tribe-tickets__commerce-checkout-cart-item post-5097 tec_tc_ticket type-tec_tc_ticket status-publish hentry tribe-common-b1" 	 data-ticket-id="5097" data-ticket-quantity="2" data-ticket-price="5.00" >
