...
<input name="provider" value="Tribe__Tickets__Commerce__PayPal__Main" class="tribe-tickets-provider" type="hidden">
	...
	id="tribe-modal-tickets-item-[TICKET_ID_1]"
	 class="tribe-tickets__tickets-item post-[TICKET_ID_1] tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	 data-ticket-id="[TICKET_ID_1]" data-available="true" data-has-shared-cap="false" data-ticket-price="99" >
...
<div class="tribe-common-b3 tribe-tickets__tickets-item-extra-available">
	...
	title="Decrease ticket quantity for Test ticket for [EVENT_ID]"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Decrease ticket quantity for Test ticket for [EVENT_ID]</span>
	-</button>
		
<div  class="tribe-tickets__tickets-item-quantity-number" >
	<label
		class="tribe-common-a11y-visual-hide"
		for="tribe-tickets__tickets-item-quantity-number--[TICKET_ID_1]"
	>
		Quantity	</label>
	<input
		id="tribe-tickets__tickets-item-quantity-number--[TICKET_ID_1]"
		type="number"
	...
	title="Increase ticket quantity for Test ticket for [EVENT_ID]"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Increase ticket quantity for Test ticket for [EVENT_ID]</span>
	+</button>
	</div>
...
<div
	id="tribe-modal-tickets-item-[TICKET_ID_2]"
	 class="tribe-tickets__tickets-item post-[TICKET_ID_2] tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	 data-ticket-id="[TICKET_ID_2]" data-available="true" data-has-shared-cap="false" data-ticket-price="99" >
...
<div  class="tribe-tickets__tickets-item-quantity-number" >
	<label
		class="tribe-common-a11y-visual-hide"
		for="tribe-tickets__tickets-item-quantity-number--[TICKET_ID_2]"
	>
		Quantity	</label>
	<input
		id="tribe-tickets__tickets-item-quantity-number--[TICKET_ID_2]"
		type="number"
		class="tribe-common-h3 tribe-common-h4--min-medium tribe-tickets__tickets-item-quantity-number-input"
		step="1"
		min="0"
