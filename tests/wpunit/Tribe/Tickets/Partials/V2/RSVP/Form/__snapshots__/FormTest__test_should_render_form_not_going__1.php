...
<form
	...
	data-rsvp-id="3356"
>
	<input type="hidden" name="tribe_tickets[3356][ticket_id]" value="3356">
	<input type="hidden" name="tribe_tickets[3356][attendees][0][order_status]" value="not-going">
	...
	<input
		...
		name="tribe_tickets[3356][attendees][0][full_name]"
...
<div class="tribe-common-b1 tribe-tickets__form-field tribe-tickets__form-field--required">
	...
	<input
		...
		name="tribe_tickets[3356][attendees][0][email]"
...
<div class="tribe-common-b1 tribe-tickets__form-field tribe-tickets__form-field--required">
	...
	<input
		type="number"
		name="tribe_tickets[3356][quantity]"
		id="quantity_3356"
