<?php return '		<div class="tribe-tickets__item__details__summary">
			<button
				...
				aria-controls="tribe__details__content1--12049"
				tabindex="0"
			>
...
<div id="tribe__details__content1--12049" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
