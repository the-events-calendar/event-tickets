...
>
	...
	id="tribe-block-tickets-item-9"
	 class="tribe-tickets__item post-9 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="9"
	data-available="true"
...
>
	...
	<div id="tribe__details__content--9" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
...
available	</div>
			...
			<button
				...
				aria-controls="tribe__details__content--9"
				tabindex="0"
			>
	...
	title="Decrease ticket quantity for Test ticket for 8"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Decrease ticket quantity for Test ticket for 8</span>
	-</button>
		<div
 class="tribe-tickets__item__quantity__number" >
	...
	title="Increase ticket quantity for Test ticket for 8"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Increase ticket quantity for Test ticket for 8</span>
	+</button>
	</div>	
	...
	<label
		...
		for="tribe-tickets-attendees-list-optout-9"
	>
		<input
			class="tribe-common-form-control-checkbox__input tribe-tickets__item__optout"
			id="tribe-tickets-attendees-list-optout-9"
