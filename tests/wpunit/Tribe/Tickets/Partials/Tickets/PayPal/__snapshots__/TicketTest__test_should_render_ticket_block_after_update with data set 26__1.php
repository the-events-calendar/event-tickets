...
>
	...
	<input name="provider" value="Tribe__Tickets__Commerce__PayPal__Main" class="tribe-tickets-provider" type="hidden">
									<div
	id="tribe-block-tickets-item-95"
	 class="tribe-tickets__item post-95 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="95"
	data-available="true"
...
>
	...
	<div  class="tribe-common-h7 tribe-common-h6--min-medium tribe-tickets__item__content__title"  >
		Test ticket for 94</div>
	<div id="tribe__details__content--95" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
	Test ticket description for 94</div>
...
available	</div>
			...
			<button
				...
				aria-controls="tribe__details__content--95"
				tabindex="0"
			>
	...
	title="Decrease ticket quantity for Test ticket for 94"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Decrease ticket quantity for Test ticket for 94</span>
	-</button>
		<div
 class="tribe-tickets__item__quantity__number" >
	...
	title="Increase ticket quantity for Test ticket for 94"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Increase ticket quantity for Test ticket for 94</span>
	+</button>
	</div>	
	...
	<label
		...
		for="tribe-tickets-attendees-list-optout-95"
	>
		<input
			class="tribe-common-form-control-checkbox__input tribe-tickets__item__optout"
			id="tribe-tickets-attendees-list-optout-95"
			...
			type="checkbox"
			 checked=\'checked\'		/>Hide my attendee data from public view.</label>
								...
								<div
	id="tribe-block-tickets-item-96"
	 class="tribe-tickets__item post-96 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="96"
	data-available="true"
	data-has-shared-cap="false"
...
>
	...
	<div  class="tribe-common-h7 tribe-common-h6--min-medium tribe-tickets__item__content__title"  >
		Test ticket for 94</div>
	<div id="tribe__details__content--96" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
	Test ticket description for 94</div>
<div class="tribe-tickets__item__extra">
	<div
	class="tribe-common-b2 tribe-common-b1--min-medium tribe-tickets__item__extra__price"
...
available	</div>
			...
			<button
				type="button"
				class="tribe-common-b3 tribe-tickets__item__details__summary--more"
				aria-controls="tribe__details__content--96"
				tabindex="0"
			>
				<span class="screen-reader-text tribe-common-a11y-visual-hide">Open the ticket description.</span>
				More			</button>
...
>
	...
	<label
		class="tribe-common-form-control-checkbox__label"
		for="tribe-tickets-attendees-list-optout-96"
	>
		<input
			class="tribe-common-form-control-checkbox__input tribe-tickets__item__optout"
			id="tribe-tickets-attendees-list-optout-96"
			name="attendee[optout]"
			type="checkbox"
			 checked=\'checked\'		/>Hide my attendee data from public view.</label>
</div>
