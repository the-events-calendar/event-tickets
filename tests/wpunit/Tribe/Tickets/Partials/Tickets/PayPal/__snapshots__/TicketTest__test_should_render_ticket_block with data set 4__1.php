...
>
	...
	<input name="provider" value="Tribe__Tickets__Commerce__PayPal__Main" class="tribe-tickets-provider" type="hidden">
									<div
	id="tribe-block-tickets-item-13"
	 class="tribe-tickets__item post-13 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="13"
	data-available="true"
...
>
	...
	<div  class="tribe-common-h7 tribe-common-h6--min-medium tribe-tickets__item__content__title"  >
		Test ticket for 12</div>
	<div id="tribe__details__content--13" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
	Test ticket description for 12</div>
...
available	</div>
	...
	title="Decrease ticket quantity for Test ticket for 12"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Decrease ticket quantity for Test ticket for 12</span>
	-</button>
		<div
 class="tribe-tickets__item__quantity__number" >
	...
	title="Increase ticket quantity for Test ticket for 12"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Increase ticket quantity for Test ticket for 12</span>
	+</button>
	</div>	
	...
	<label
		...
		for="tribe-tickets-attendees-list-optout-13"
	>
		<input
			class="tribe-common-form-control-checkbox__input tribe-tickets__item__optout"
			id="tribe-tickets-attendees-list-optout-13"
