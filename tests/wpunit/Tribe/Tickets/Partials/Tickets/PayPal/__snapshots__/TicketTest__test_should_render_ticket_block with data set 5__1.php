...
>
	...
	id="tribe-block-tickets-item-15"
	 class="tribe-tickets__item post-15 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="15"
	data-available="true"
...
>
	...
	<div  class="tribe-common-h7 tribe-common-h6--min-medium tribe-tickets__item__content__title"  >
		Test ticket for 14</div>
	<div id="tribe__details__content--15" class="tribe-common-b2 tribe-common-b3--min-medium tribe-tickets__item__details__content">
	Test ticket description for 14</div>
...
available	</div>
			...
			<button
				...
				aria-controls="tribe__details__content--15"
				tabindex="0"
			>
	...
	title="Decrease ticket quantity for Test ticket for 14"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Decrease ticket quantity for Test ticket for 14</span>
	-</button>
		<div
 class="tribe-tickets__item__quantity__number" >
	...
	title="Increase ticket quantity for Test ticket for 14"
	type="button"
>
	<span class="screen-reader-text tribe-common-a11y-visual-hide">Increase ticket quantity for Test ticket for 14</span>
	+</button>
	</div>	
	...
	<label
		...
		for="tribe-tickets-attendees-list-optout-15"
	>
		<input
			class="tribe-common-form-control-checkbox__input tribe-tickets__item__optout"
			id="tribe-tickets-attendees-list-optout-15"
