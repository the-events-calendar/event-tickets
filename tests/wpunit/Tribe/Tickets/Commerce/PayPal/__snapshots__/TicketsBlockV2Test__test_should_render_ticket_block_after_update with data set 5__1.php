...
<input name="provider" value="Tribe__Tickets__Commerce__PayPal__Main" class="tribe-tickets-provider" type="hidden">
	...
	id="tribe-block-tickets-item-[TICKET_ID]"
	 class="tribe-tickets__tickets-item post-[TICKET_ID] tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry entry" 	 data-ticket-id="[TICKET_ID]" data-available="true" data-has-shared-cap="true" data-ticket-price="5" data-shared-cap="15" data-available-count="10" >
...
<div class="tribe-common-b3 tribe-tickets__tickets-item-extra-available">
	...
	<span class="tribe-tickets__tickets-item-extra-available-quantity"> 10 </span> available
</div>
...
<div  class="tribe-tickets__tickets-item-quantity-number" >
	<label
		...
		for="tribe-tickets__tickets-item-quantity-number--[TICKET_ID]"
	>
		Quantity	</label>
	<input
		id="tribe-tickets__tickets-item-quantity-number--[TICKET_ID]"
		type="number"
