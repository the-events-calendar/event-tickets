...
>
	...
	id="tribe-block-tickets-item-123"
	 class="tribe-tickets__item post-123 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="29"
		...
		<input
			...
			type="checkbox"
			 checked=\'checked\'		/>Hide my attendee data from public view.</label>
								...
								<div
	id="tribe-block-tickets-item-123"
	 class="tribe-tickets__item post-123 tribe_tpp_tickets type-tribe_tpp_tickets status-publish hentry" 	data-ticket-id="30"
	data-available="false"
	data-has-shared-cap="false"
