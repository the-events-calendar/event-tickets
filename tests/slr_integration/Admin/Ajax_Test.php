...
class Ajax_Test extends Controller_Test_Case {
	...
	public function it_should_filter_seating_totals(): void {
		...
		$this->assertEquals( $totals_1, $tickets_handler->get_ticket_totals( get_post( $ticket_id_1 ) ) );
		$this->assertEquals( $totals_2, $tickets_handler->get_ticket_totals( get_post( $ticket_id_2 ) ) );
		$this->assertEquals( $totals_3, $tickets_handler->get_ticket_totals( get_post( $ticket_id_3 ) ) );
	}
