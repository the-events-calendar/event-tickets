	...
	Total Event Capacity:	<span id="ticket_form_total_capacity_value" title="The total number of possible attendees for this event">
		100	</span>
				...
				<a
					...
					href="http://wordpress.test/wp-admin/edit.php?post_type=tribe_events&#038;page=tickets-attendees&#038;event_id=5104"
				>
					View Attendees				</a>
			</div>
...
<div id="ticket_list_wrapper">
	...
	data-ticket-order-id="order_5105"
	data-ticket-type-id="5105"
	data-ticket-type="default">
	<td class="column-primary ticket_name Tribe__Tickets__RSVP" data-label="Ticket Type:">
		<input
			type="hidden"
			class="tribe-ticket-field-order"
			name="tribe-tickets[list][5105][order]"
			value="0"
			disabled		>
	...
	<td class="ticket_edit">
		<button data-provider='Tribe__Tickets__RSVP' data-ticket-id='5105' title='Edit Ticket ID: 5105' class='ticket_edit_button'><span class='ticket_edit_text'>Test RSVP ticket for 5104</span></a><button data-provider='Tribe__Tickets__RSVP' data-ticket-id='5105' title='Duplicate Ticket ID: 5105' class='ticket_duplicate'><span class='ticket_duplicate_text'>Test RSVP ticket for 5104</span></a><button attr-provider='Tribe__Tickets__RSVP' attr-ticket-id='5105' title='Delete Ticket ID: 5105' class='ticket_delete'><span class='ticket_delete_text'>Test RSVP ticket for 5104</span></a>	</td>
</tr>
		</tbody>
	</table>
			...
			<section id="ticket_form_main" class="main"
				...
				<div class="input_block">
					...
					<input
							...
							size='25'
							value="Test RSVP ticket for 5104"
				...
				<div class="input_block">
					...
					>Ticket RSVP ticket excerpt for 5104</textarea>
					<div class="input_block">
				...
				<div class="input_block">
					...
					<div class="ticket_form_right">
						...
						<span class="helper-text hide-if-js">HH:MM</span>
						<span class="dashicons dashicons-editor-help"
							  title="If you do not set an end sale date, tickets will be available until the event begins."
						></span>
					</div>
				</div>
		...
		<div id="advanced_fields">
			<div id="Tribe__Tickets__Commerce__PayPal__Main_advanced" class="tribe-dependent" data-depends="#Tribe__Tickets__Commerce__PayPal__Main_radio" data-condition-is-checked></div>		</div>
				...
				<div id="ticket_bottom_right">
					<a href="?dialog=move_ticket_types&ticket_type_id=5105&check=2c0ebc32a8&TB_iframe=true" class="thickbox tribe-ticket-move-link">Move RSVP</a> | <span><a href="#" attr-provider="Tribe__Tickets__RSVP" attr-ticket-id="5105" id="ticket_delete_5105" class="ticket_delete">Delete RSVP</a></span>				</div>
			</div>
		</div>
	</div>
</div>
