...
>
	...
	<a
		href="http://wordpress.test/wp-admin/edit.php?post_type=tribe_events&#038;page=tpp-orders&#038;event_id=5100"
		class="button-secondary"
	>
		View Orders	</a>
				<a
					class="button-secondary"
					href="http://wordpress.test/wp-admin/edit.php?post_type=tribe_events&#038;page=tickets-attendees&#038;event_id=5100"
				>
					View Attendees				</a>
			</div>
...
<div id="ticket_list_wrapper">
	...
	<table id="tribe_ticket_list_table" class="tribe-tickets-editor-table eventtable ticket_list eventForm widefat fixed">
		...
		<tr class="TEC\Tickets\Commerce\Module is-expanded"
	data-ticket-order-id="order_5101"
	data-ticket-type-id="5101"
	data-ticket-type="default">
	<td class="column-primary ticket_name TEC\Tickets\Commerce\Module" data-label="Ticket Type:">
		<input
			type="hidden"
			class="tribe-ticket-field-order"
			name="tribe-tickets[list][5101][order]"
			value="-1"
					>
	...
	<td class="ticket_edit">
		<button data-provider='TEC\Tickets\Commerce\Module' data-ticket-id='5101' title='Edit Ticket ID: 5101' class='ticket_edit_button'><span class='ticket_edit_text'>Test TC ticket for 5100</span></a><button data-provider='TEC\Tickets\Commerce\Module' data-ticket-id='5101' title='Duplicate Ticket ID: 5101' class='ticket_duplicate'><span class='ticket_duplicate_text'>Test TC ticket for 5100</span></a><button attr-provider='TEC\Tickets\Commerce\Module' attr-ticket-id='5101' title='Delete Ticket ID: 5101' class='ticket_delete'><span class='ticket_delete_text'>Test TC ticket for 5100</span></a>	</td>
</tr>
		</tbody>
