<?php return '<div class="tribe-common event-tickets"><span id="tec-tickets__emails-preview-dialog"></span><script data-js="dialog-content-tec-tickets__emails-preview-dialog" type="text/template">
			<h2  class="tribe-dialog__title tribe-modal__title tribe-common-h5 tribe-modal__title--emails-preview" >Email Preview</h2>
