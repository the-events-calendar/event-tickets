<?php return '{
    ...
    "tec-tickets-emails-header-image-alignment": {
        "type": "dropdown",
    ...
    "tec-tickets-emails-header-bg-color": {
        "type": "color",
    ...
    "tec-tickets-emails-ticket-bg-color": {
        "type": "color",
        "label": "Ticket Color",
        "size": "medium",
        "default": "#2D2E33",
    ...
    "tec-tickets-emails-footer-content": {
        "type": "wysiwyg",
        "label": "Footer Content",
        "tooltip": "Add custom links and instructions to the bottom of your emails.",
        "default": "",
