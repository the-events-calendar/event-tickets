<?php
/**
 * Jetpack Changelogger Formatter for Event Tickets
 *
 * @package Event Tickets
 */
 ...
 * Jetpack Changelogger Formatter for Event Tickets
 *
 * Class ET_Changelog_Formatter
 */
class ET_Changelog_Formatter extends Parser implements FormatterPlugin {
	use PluginTrait;
	 ...
	 * @var string
	 */
	private $title = '# Event Tickets Changelog';
