...
( function ( $, obj ) {
	...
	obj.selectors = [ '.tribe-tickets__item__details__summary--more', '.tribe-tickets__item__details__summary--less' ];
	...
	obj.toggle_open = function ( trigger ) {
		...
		const $parent = $trigger.closest( '.tribe-tickets__item__details__summary' );
	...
	$( function () {
		const detailsElems = document.querySelectorAll( '.tribe-tickets__item__details__summary' );
