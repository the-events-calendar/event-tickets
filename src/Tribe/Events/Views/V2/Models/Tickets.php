...
class Tickets implements ArrayAccess {
	 ...
	 *
	 * @since 5.7.0
	 * @deprecated 5.28.6 Use __serialize() instead.
	 *
	 * @return string
	 */
	public function serialize() {
		_deprecated_function( __METHOD__, '5.28.6', '__serialize()' );
	 ...
	 *
	 * @since 5.7.0
	 * @deprecated 5.28.6 Use __unserialize() instead.
	 *
	...
	public function unserialize( $serialized ) {
		_deprecated_function( __METHOD__, '5.28.6', '__unserialize()' );
