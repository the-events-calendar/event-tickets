...
class Tribe__Tickets__Assets {
	...
	public function admin_enqueue_scripts() {
		...
		$assets = [
				...
				[ 'event-tickets-admin-js', 'tickets.js', [ 'jquery-ui-datepicker', 'tribe-bumpdown', 'tribe-attrchange', 'tribe-moment', 'underscore', 'tribe-validation', 'event-tickets-admin-accordion-js', 'tribe-timepicker' ], 'admin_enqueue_scripts', [ 'priority' => 99 ] ],
		];
