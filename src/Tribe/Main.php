...
class Tribe__Tickets__Main {
	...
	public function bind_implementations() {
		...
		tribe_singleton( 'tickets.ticket-repository', 'Tribe__Tickets__Ticket_Repository' );
		tribe_singleton( 'tickets.attendee-repository', 'Tribe__Tickets__Attendee_Repository' );
