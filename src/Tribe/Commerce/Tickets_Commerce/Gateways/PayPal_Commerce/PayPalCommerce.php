...
class PayPalCommerce implements PaymentGateway {
	...
	public function getName() {
		return esc_html__( 'PayPal Donations', 'event-tickets' );
	}
	...
	public function getPaymentMethodLabel() {
		return esc_html__( 'Credit Card', 'event-tickets' );
	}
