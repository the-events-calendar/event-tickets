...
class Tribe__Tickets__Commerce__Cart {
	...
	public function process_cart() {
		...
		$provider = isset( $data['tribe_tickets_provider'] ) ? sanitize_text_field( $data['tribe_tickets_provider'] ) : tribe_get_request_var( Tribe__Tickets__Tickets::get_provider_url_slug() );
