...
/**
 * Class Tribe__Tickets__Orders_Table
 *
 * See documentation for WP_List_Table
 */
class Tribe__Tickets__Orders_Table extends WP_List_Table {
	public $event_id;
	...
	public function column_order( $item ) {
		...
		$output = "{$order_number_link} " . __( 'by', 'event-tickets' ) . " {$customer_name}<br><a href=\"mailto:{$customer_email}\">{$customer_email}</a>";
