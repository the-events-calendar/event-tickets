...
class Tribe__Tickets__REST__V1__Validator__Base
	...
	public function is_venue_id_or_entry( $venue ) {
		...
		/** @var Tribe__Tickets__REST__V1__Endpoints__Linked_Post_Endpoint_Interface $venue_endpoint */
	...
	public function is_organizer_id_or_entry( $organizer ) {
		...
		foreach ( $organizers as $entry ) {
			...
			$request = new WP_REST_Request();
			/** @var Tribe__Tickets__REST__V1__Endpoints__Linked_Post_Endpoint_Interface $organizer_endpoint */
