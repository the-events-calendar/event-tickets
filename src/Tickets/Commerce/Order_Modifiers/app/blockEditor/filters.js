...
addFilter( 'tec.ticket.container.items', namespace, filterTicketContainerItems );

// Set the fees for the ticket.
addAction( 'tec.tickets.blocks.fetchTicket', namespace, setFeesForTicket );

addAction( 'tec.tickets.blocks.ticketUpdated', namespace, updateFeesForTicket );

addAction( 'tec.tickets.blocks.ticketCreated', namespace, updateFeesForTicket );
