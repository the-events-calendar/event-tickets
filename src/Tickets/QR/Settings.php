...
class Settings {
	 ...
	 */
	protected static string $enabled_key = 'tickets-enable-qr-codes';
	 ...
	 * @var string The option key.
	 */
	protected static string $api_hash_key = 'tickets-plus-qr-options-api-key';
	 ...
	 * @return string
	 */
	public static function get_enabled_key(): string {
		return static::$enabled_key;
	}
	 ...
	 * @return string
	 */
	protected static function get_api_hash_key(): string {
		return static::$api_hash_key;
	}
	...
	public function is_enabled( $context = null ): bool {
		 ...
		 */
		$enabled = apply_filters_deprecated( 'tribe_tickets_plus_qr_enabled', [ $enabled, $context ], 'TBD', '' );
	 ...
	 */
	protected function generate_api_hash(): string {
		 ...
		 */
		$hash = apply_filters_deprecated( 'tribe_tickets_plus_qr_api_hash', [ $hash ], 'TBD', 'tec_tickets_qr_settings_generated_api_hash' );
		 ...
		 */
		return apply_filters( 'tec_tickets_qr_settings_generated_api_hash', $hash );
	}
	 ...
	 * @return string
	 */
	public function get_api_hash(): string {
		$api_key = tribe_get_option( static::get_api_hash_key(), '' );

		if ( empty( $api_key ) ) {
			$api_key = $this->generate_api_hash();
			tribe_update_option( static::get_api_hash_key(), $api_key );
		}
	 ...
	 * @return bool
	 */
	public function delete_api_hash(): bool {
		return (bool) tribe_remove_option( static::get_api_hash_key() );
	}
}