...
import { ACTION_REMOVE_EVENT_LAYOUT, ajaxNonce, ajaxUrl } from '../../ajax';
			...
			<Fragment>
				<div className="tec-tickets-seating__settings-intro">
					...
					<p className="warning-text">
						{ __(
							'All attendees will lose their seat assignments. All seated tickets will switch to 1 capacity.',
							'event-tickets'
						) }{ ' ' }
				...
				<div className="tec-tickets-seating__settings--actions">
					<Button onClick={ handleRemoveLayout } disabled={ ! isChecked } isPrimary={ isChecked }>
