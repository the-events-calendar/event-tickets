...
const getMessage = ( serviceStatus, serviceConnectUrl ) => {
	...
	switch ( serviceStatus ) {
		...
		case 'not-connected':
			return (
				<span style={ style }>
					{ __( 'Your site is not connected to the Seating Builder service.', 'event-tickets' ) }{ ' ' }
					<a style={ anchorStyle } href={ serviceConnectUrl } target="_blank" rel="noreferrer noopener">
						{ _x(
		...
		case 'expired-license':
			return (
				<span style={ style }>
					{ __( 'Your license for Seating has expired.', 'event-tickets' ) }{ ' ' }
					<a style={ anchorStyle } href="https://evnt.is/1bdu" target="_blank" rel="noreferrer noopener">
						{ _x(
		...
		case 'invalid-license':
			return (
				<span style={ style }>
					{ __( 'Your license for Seating is invalid.', 'event-tickets' ) }{ ' ' }
					<a style={ anchorStyle } href="https://evnt.is/1bdu" target="_blank" rel="noreferrer noopener">
						{ _x(
					...
					{ __( 'or', 'event-tickets' ) }{ ' ' }
					<a style={ anchorStyle } href="https://evnt.is/1be1" target="_blank" rel="noreferrer noopener">
						{ _x( 'log into your account.', 'link label for account login', 'event-tickets' ) }
					</a>
				</span>
			);
