...
class Glance_Items {
	 ...
	 * @since 5.28.6 Add filter to allow disabling the glance item attendee count.
	 *
	 ...
	 *
	 * @since 5.6.0
	 * @since 5.28.6 Replace full object hydration with a single COUNT query via the Repository.
	 * @since 5.28.6 Always persist the transient (even when count is zero) to prevent infinite cron rescheduling.
	 * @since 5.28.6 Exclude RSVP "not going" attendees via the `rsvp_status__or_none` Repository filter.
	 */
