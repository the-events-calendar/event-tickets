...
const Save = ( { innerBlocks, state, blockProps } ) => {
    ...
    const saveInnerBlocks = innerBlocks.filter ( function ( block ) {
         ...
         */
        return applyFilters ( 'tec_tickets_save_ticket_block_from_post', true, ticket, currentPost );
    } );
     ...
     */
    return ( <div{ ...blockProps } dangerouslySetInnerHTML={ { __html: serializedInnerBlocks } }></div> );
};
