...
class Failed_Order extends \TEC\Tickets\Emails\Email_Abstract {
	 ...
	 * @var string
	 */
	public static $option_enabled = 'tec_tickets_emails_failed_order_option_enabled';
	 ...
	 * @var string
	 */
	public static $option_recipient = 'tec_tickets_emails_failed_order_option_recipient';
	 ...
	 * @var string
	 */
	public static $option_subject = 'tec_tickets_emails_failed_order_option_subject';
	 ...
	 * @var string
	 */
	public static $option_heading = 'tec_tickets_emails_failed_order_option_heading';
	 ...
	 * @var string
	 */
	public static $option_add_content = 'tec_tickets_emails_failed_order_option_add_content';
	...
	public function get_recipient(): string {
		 ...
		 */
		$recipient = apply_filters( 'tec_tickets_emails_recipient_' . $this->id, $recipient, $this->id, $this->template );
