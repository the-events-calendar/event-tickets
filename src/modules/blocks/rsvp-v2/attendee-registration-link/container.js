 ...
 */
import RSVPAttendeeRegistrationLink from './template';
...
export default compose( withStore(), connect( mapStateToProps, mapDispatchToProps ) )( RSVPAttendeeRegistrationLink );
