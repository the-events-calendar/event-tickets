...
const datePickerFormat = getRsvpDateFormat();
...
const startDateInput = currentMoment.format( momentUtil.toFormat( datePickerFormat ) );
const endDateInput = endMoment.format( momentUtil.toFormat( datePickerFormat ) );
