const {
    fieldSelector, containerSelector, differentProviderNoticeSelector, differentProviderNoticeTemplate,
 ...
 *
 * @returns {string|null} The title of the series read from the selected option data, `null` if not found.
 */
