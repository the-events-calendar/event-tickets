...
>
	...
	<input type='text' id='Tribe__Tickets__RSVP_capacity' name='ticket_stock' class="ticket_field ticket_stock ticket_form_right" size='7' value='<?php echo esc_attr( $stock ); ?>'/>
