...
if (
	...
	$et_options_display['tickets_use_new_views'] = [
		...
		'tooltip'         => wp_kses_post(
			sprintf(
			// Translators: %1$s: dynamic "Tickets" text.
				_x( 'Enables updated front-end views and Individual Attendee Collection (IAC) flows for %1$s. You\'ll see a new default setting within the Tickets tab and new individual ticket setting within both Classic and Gutenberg editors <a href="https://m.tri.be/kb">[Learn more]</a>.', 'settings tooltip', 'event-tickets' ),
				tribe_get_ticket_label_plural( 'tickets_use_new_views' )
			)
		),
		'validation_type' => 'boolean',
