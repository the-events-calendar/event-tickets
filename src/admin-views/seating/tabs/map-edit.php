...
<div class="tec-tickets__tab-content__wrapper">
	...
	>
		<iframe
			...
			id="tec-events-assigned-seating-iframe-map-edit"
			class="tec-events-assigned-seating__iframe tec-events-assigned-seating__iframe--map-edit"
			title="<?php esc_html_e( 'Controller Configuration', 'events-assigned-seating' ); ?>"></iframe>
	</div>
</div>