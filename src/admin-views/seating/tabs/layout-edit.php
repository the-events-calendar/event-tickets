...
<div class="tec-tickets__tab-content__wrapper">
	...
	>
		<iframe
			...
			id="tec-events-assigned-seating-iframe-layout-edit"
			class="tec-events-assigned-seating__iframe tec-events-assigned-seating__iframe--layout-edit"
			title="<?php esc_html_e( 'Seat Layout', 'events-assigned-seating' ); ?>"></iframe>
	</div>
</div>
