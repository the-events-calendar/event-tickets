	...
	if ( get_post_meta( get_the_ID(), '_EventOrigin', true ) === 'community-events' ) {
		...
		<tr>
			<td colspan="2" class="tribe_sectionheader updated">
				<p class="error-message"><?php esc_html_e( 'This event was created using Community Events. Are you sure you want to sell tickets for it?', 'tribe-tickets' ); ?></p>
			</td>
		</tr>
	<?php
	}
		...
		<td colspan="2" class="tribe_sectionheader updated">
			<table class="eventtable ticket_list eventForm">
				<tr class="tribe-tickets-image-upload">
					<td>
						<?php esc_html_e( 'Upload image for the ticket header', 'tribe-tickets' ); ?>
						<p class="description"><?php esc_html_e( 'The maximum image size in the email will be 580px wide by any height, and then scaled for mobile. If you would like "retina" support use an image sized to 1160px wide.', 'tribe-tickets' ); ?></p>
					</td>
					<td>
						<input type="button" class="button" name="tribe_ticket_header_image" id="tribe_ticket_header_image" value="<?php esc_html_e( 'Select an Image', 'tribe-tickets' ); ?>" />
					</td>
				</tr>
	...
	<tr>
		<td colspan="2" class="tribe_sectionheader">
			<a href="#" class="button-secondary"
			   id="ticket_form_toggle"><?php esc_html_e( 'Add new ticket', 'tribe-tickets' ); ?></a>
		</td>
	</tr>
	<tr id="ticket_form" class="ticket_form">
		<td colspan="2" class="tribe_sectionheader">
			...
			<table id="ticket_form_table" class="eventtable ticket_form">
				...
				<tr>
					<td colspan="2">
						<h4 class="ticket_form_title_add"><?php esc_html_e( 'Add new ticket', 'tribe-tickets' ); ?></h4>
						<h4 class="ticket_form_title_edit"><?php esc_html_e( 'Edit ticket', 'tribe-tickets' ); ?></h4>
					</td>
				</tr>

				<tr>
					<td width="20%"><label for="ticket_provider"><?php esc_html_e( 'Sell using:', 'tribe-tickets' ); ?></label></td>
					<td>
						<?php
						$checked = true;
				...
				<tr>
					<td><label for="ticket_name"><?php esc_html_e( 'Ticket Name:', 'tribe-tickets' ); ?></label></td>
					<td>
				...
				<tr class="ticket">
					<td><label
							for="ticket_description"><?php esc_html_e( 'Ticket Description:', 'tribe-tickets' ); ?></label>
					</td>
					<td>
				...
				<tr class="ticket">
					<td><label
							for="ticket_price"><?php esc_html_e( 'Price:', 'tribe-tickets' ); ?></label>
					</td>
					<td>
						<input type='text' id='ticket_price' name='ticket_price' class="ticket_field" size='7'
							   value='' />

						<p class="description"><?php esc_html_e( '(0 or empty for free tickets)', 'tribe-tickets' ) ?></p>
					</td>
				</tr>

				<tr class="ticket sale_price">
					<td><label
							for="ticket_sale_price"><?php esc_html_e( 'Sale Price:', 'tribe-tickets' ) ?></label>
					</td>
					<td>
						<input type='text' id='ticket_sale_price' name='ticket_sale_price' class="ticket_field" size='7'
							value='' readonly />

						<p class="description"><?php esc_html_e( '(Current sale price - this can be managed via the product editor)', 'tribe-tickets' ) ?></p>
					</td>
				</tr>

				<tr class="ticket">
					<td><label
							for="ticket_start_date"><?php esc_html_e( 'Start sale:', 'tribe-tickets' ); ?></label>
					</td>
					<td>
				...
				<tr class="ticket">
					<td valign="top"><label
							for="ticket_price"><?php esc_html_e( 'End sale:', 'tribe-tickets' ); ?></label>
					</td>
					<td valign="top">
						...
						<p class="description"><?php esc_html_e( "When will ticket sales occur? If you don't set a start/end date for sales, tickets will be available from now until the event ends.", 'tribe-tickets' ); ?></p>
					</td>
				</tr>
				...
				<tr class="ticket bottom">
					...
					<td>
						...
						<input type="button" id="ticket_form_save" name="ticket_form_save" value="<?php esc_html_e( 'Save this ticket', 'tribe-tickets' ); ?>"
