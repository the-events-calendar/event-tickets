...
<div class="tribe-row">
	...
	<div class="tribe-half-column">
		<h2 data-tribe-icon="dashicons-welcome-learn-more"><?php esc_html_e( 'Getting Started', 'event-tickets' ); ?></h2>
	...
	<div class="tribe-half-column">
		<h2 data-tribe-icon="dashicons-sos"><?php esc_html_e( 'Resources and Support', 'event-tickets' ); ?></h2>
...
<div class="tribe-row">
	...
	<div class="tribe-half-column">
		<h2><?php esc_html_e( 'The Latest and Greatest', 'event-tickets' ); ?></h2>
...
<div class="tribe-row">
	<div class="tribe-half-column">
		<h2 data-tribe-icon="dashicons-heart"><?php esc_html_e( 'We Need Your Help', 'event-tickets' ); ?></h2>
