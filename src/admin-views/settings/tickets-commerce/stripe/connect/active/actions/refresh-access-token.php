...
$url = Tribe__Settings::instance()->get_url( [ 'tab' => 'payments', 'tc-action' => 'stripe-refresh-access-token' ] );
?>

<a
	href="<?php echo esc_url( $url ); ?>"
	class="tec-tickets__admin-settings-tickets-commerce-stripe-refresh-link"
