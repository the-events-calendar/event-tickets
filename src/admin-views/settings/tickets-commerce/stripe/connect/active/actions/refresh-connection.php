...
$resync_connection_url = Tribe__Settings::instance()->get_url( [ 'tab' => 'payments', 'tc-action' => 'stripe-resync-connection' ] );
?>
<div class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-row">
	<div class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-col1"></div>
	<div class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-col2">
	<a
		href="<?php echo esc_url( $resync_connection_url ); ?>"
		class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-resync-button"
	>
		<?php tribe( 'tickets.editor.template' )->template( 'v2/components/icons/reset', [ 'classes' => [ 'tec-tickets__admin-settings-tickets-commerce-stripe-connected-resync-button-icon' ] ] ); ?>
