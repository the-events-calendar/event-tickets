...
<div class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-row">
	...
	<div class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-col2">
		...
		foreach ( $webhooks_events->get_registered_events() as $event_name ) :
			...
			$classes = [
				'tec-tickets__admin-settings-tickets-commerce-stripe-connected-webhook',
				'tec-tickets__admin-settings-tickets-commerce-stripe-connected-webhook--active' => $is_active,
			]
			?>
			<div <?php tribe_classes( $classes ); ?>>
				<span class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-webhook-name">
					<?php echo esc_html( $webhook_label ); ?>
				</span>
				<span class="tec-tickets__admin-settings-tickets-commerce-stripe-connected-webhook-error">
