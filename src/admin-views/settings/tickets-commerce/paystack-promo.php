...
<div class="tec-tickets__admin-after-pay-promo-container">
	...
	<div class="tec-tickets__admin-after-pay-promo-content-container">
		...
		<div class="tec-tickets__admin-after-pay-promo-description">
			<?php echo wp_kses( esc_html__( 'Accept payments for your ticket sales in Nigeria, Ghana, South Africa, and Kenya with Paystack.  Install the free plugin to get started.', 'event-tickets' ), 'post' ); ?>
		</div>
