...
<form method="post" action="" id="tec-settings-form">
	<div class="tribe-settings-form-wrap">
		...
		<fieldset>
			...
			<input type="text" name="order_modifier_coupon_name" id="order_modifier_coupon_name" class="tribe-field"
		...
		<fieldset>
			...
			<p>A unique code has been created for this coupon. You can override this code by replacing it with your own
		...
		<fieldset>
			...
			<input type="number" name="order_modifier_coupon_limit" id="order_modifier_coupon_limit" class="tribe-field"
