...
$disabled   = false;
$classes    = [ 'tribe-common-b1', 'tribe-field', 'tribe-tickets__item__attendee__field__datetime' ];
if ( $required ) {
...
<div <?php tribe_classes( $classes ); ?> >
	...
	<input
			...
			min="<?php echo esc_attr( (int) date_i18n( 'Y' ) - 100 ); ?>-01-01"
			max="<?php echo esc_attr( (int) date_i18n( 'Y' ) + 100 ); ?>-31-12"
