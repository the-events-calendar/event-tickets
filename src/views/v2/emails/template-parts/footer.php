 ...
 * [your-theme]/tribe/tickets/v2/emails/template-parts/footer.php
 *
...
$this->template( 'template-parts/footer/footer-preview' );

$this->template( 'template-parts/footer/footer' );
