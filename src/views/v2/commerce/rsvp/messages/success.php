 ...
 * [your-theme]/tribe/tickets/v2/commerce/rsvp/messages/success.php
 *
...
<div class="tribe-tickets__rsvp-message tribe-tickets__rsvp-message--success tribe-common-b3">
	...
	<?php $this->template( 'v2/commerce/rsvp/messages/success/going' ); ?>

	<?php $this->template( 'v2/commerce/rsvp/messages/success/not-going' ); ?>
