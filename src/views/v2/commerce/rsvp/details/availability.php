 ...
 * [your-theme]/tribe/tickets/v2/commerce/rsvp/details/availability.php
 *
...
<div class="tribe-tickets__rsvp-availability tribe-common-h6 tribe-common-h--alt tribe-common-b3--min-medium">
	<?php if ( ! $is_in_stock ) : ?>
		<?php $this->template( 'v2/commerce/rsvp/details/availability/full', [ 'rsvp' => $rsvp ] ); ?>
	<?php elseif ( $is_unlimited ) : ?>
		<?php
		$this->template(
			'v2/commerce/rsvp/details/availability/unlimited',
			[
	...
	<?php else : ?>
		<?php
		$this->template(
			'v2/commerce/rsvp/details/availability/remaining',
			[
				'rsvp'         => $rsvp,
				'days_to_rsvp' => $days_to_rsvp,
			]
	...
	<?php if ( false !== $days_to_rsvp ) : ?>
		<?php
		$this->template(
			'v2/commerce/rsvp/details/availability/days-to-rsvp',
			[
				'rsvp'         => $rsvp,
				'days_to_rsvp' => $days_to_rsvp,
			]
