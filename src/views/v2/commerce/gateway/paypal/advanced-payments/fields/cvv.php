<?php
/**
 * Tickets Commerce: Checkout Advanced Payments for PayPal - CVV field
 *
 * Override this template in your own theme by creating a file at:
 * [your-theme]/tribe/tickets/v2/commerce/gateway/paypal/advanced-payments/fields/cvv.php
 *
...
$field_classes = [
	...
	'tribe-tickets__commerce-checkout-paypal-advanced-payments-form-field--cvv',
];

?>
<div class="tribe-tickets__commerce-checkout-paypal-advanced-payments-form-field-wrapper">
	<label for="tec-tc-cvv" <?php tribe_classes( $label_classes ); ?>>
