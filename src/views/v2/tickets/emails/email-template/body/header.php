...
?>
<tr>
	<td style="padding:5px 5px 0px 5px;background:<?php echo esc_attr( $header_bg_color ); ?>;text-align:<?php echo esc_attr( $header_image_alignment ); ?>" align="<?php echo esc_attr( $header_image_alignment ); ?>">
